# AGENTS.md: THE CODEX AGENT

**Developed by Vedant Parmar**

> This file is auto-discovered by Codex CLI when you run `codex` from your project directory
...
```
codex/
├── AGENTS.md                   # This file - Auto-discovered System Instructions
