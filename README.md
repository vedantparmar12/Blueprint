...
This extension integrates with Codex CLI using an **AGENTS.md file discovery approach**:

1. **AGENTS.md** contains all system instructions for Codex CLI
2. **Protocol files** define detailed operational procedures
3. **Codex CLI** automatically discovers and loads AGENTS.md from your project directory
...
└────────────────────┬────────────────────────────────────┘
                     │
                     │ Auto-discovers codex/AGENTS.md
                     ▼
┌─────────────────────────────────────────────────────────┐
│                   AGENTS.md                             │
...
### Why AGENTS.md Discovery?

**For Codex CLI**: Codex CLI automatically discovers AGENTS.md files in your project directory. This approach:
...
#### 3. Rename AGENT.md to AGENTS.md

```bash
# Codex CLI expects AGENTS.md (plural)
cd codex
...
```bash
# Start Codex CLI (it auto-discovers AGENTS.md)
cd /path/to/your/project
codex
...
**Every time you start Codex CLI**, navigate to your project directory:
...
Codex will automatically discover and load `codex/AGENTS.md`

**Pro tip**: Create a shell alias to make this easier:

```bash
# Add to your ~/.bashrc or ~/.zshrc
alias codex-prd='cd /path/to/your/project && codex'
...
│   ├── AGENTS.md                   # Auto-discovered by Codex CLI
...
**Solution**: Ensure you're in the correct directory and AGENTS.md exists:
```bash
cd /path/to/your/project
ls codex/AGENTS.md  # Verify file exists
codex               # Start Codex (auto-discovers AGENTS.md)
```
...
**Q: Do I need to navigate to the project directory every time?**

A: Yes. Codex CLI auto-discovers AGENTS.md from your project directory. Create an alias to make it easier:
```bash
alias codex-prd='cd /path/to/your/project && codex'
```
